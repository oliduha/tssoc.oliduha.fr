...
{{% notice info %}}
Le projet "ScrapPy" est disponible et documenté sur {{% button href="https://github.com/oliduha/scrappy/" icon=" " %}}github{{% /button %}}

{{% /notice %}}

Voici le contenu du module scrapper.py contenant les diverses fonctions appelées depuis le code principal (main.py).
