...
The MathJax configuration parameters can also be set on a specific page. In this case, the global parameter would be overwritten by the local one. See [Math]({{< relref "hugo/shortcodes/math" >}}) for additional documentation.
...
The Mermaid configuration parameters can also be set on a specific page. In this case, the global parameter would be overwritten by the local one. See [Mermaid]({{< relref "hugo/shortcodes/mermaid" >}}) for additional documentation.
