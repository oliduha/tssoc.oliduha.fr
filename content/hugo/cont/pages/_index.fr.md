...
The Relearn theme provides [archetypes]({{%relref "hugo/cont/archetypes" %}}) to help you create this kind of pages.
...
You can see this feature in action on the example page for [children shortcode]({{< relref "hugo/shortcodes/children" >}}) and its children pages.
